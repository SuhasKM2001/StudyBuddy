...
{
    return(
        <div className="biology_main_file">
      <h1 className="maths_heading_styling">Biology</h1>

      <h3 className="maths_liveclass_heading_style">Upcoming Live Session</h3>

      <div className="maths_liveclass_style">
        <p className="maths_liveclass_text_style">Date: 05/02/2023</p>
        <p className="maths_liveclass_text_style">Time: 6 PM</p>
        <p className="maths_liveclass_text_style">Topic: Natural Resources</p>
...
" target="_blank" className="maths_link_style">
      ...
      <section className="maths_topic_style">
        <div className="maths_subtopic1_style">
          <a href="https://youtu.be/Eq3WLj1UdzM" target="_blank" className="maths_link_style1">
            <span className="resource_style">Evolution</span>
          </a>
        </div>

        <div className="maths_subtopic2_style">
          <a href="https://youtu.be/cI1HHb88iUo" target="_blank" className="maths_link_style1">
            <span className="resource_style">Environment</span>
          </a>
        </div>

        <div className="maths_subtopic3_style">
          <a href="https://youtu.be/NimldQav2fI" target="_blank" className="maths_link_style1">
            <span className="resource_style">Natural Resouces</span>
          </a>
        </div>
      </section>
